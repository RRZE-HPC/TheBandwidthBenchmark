...
extern double triad(double *a, double *b, double *c, const double scalar, const size_t N);
extern double striad(double *a, double *b, double *c, double *d, const size_t N);
...
#ifndef _NVCC
extern double init_seq(double *a, const double scalar, const size_t N, const size_t iter);
...
extern double striad_seq(
    double *a, double *b, double *c, double *d, const size_t N, const size_t iter);
extern double daxpy_seq(
    double *a, double *b, const double scalar, const size_t N, const size_t iter);
extern double sdaxpy_seq(
    double *a, double *b, double *c, const size_t N, const size_t iter);

extern double init_tp(double *a, const double scalar, const size_t N, const size_t iter);
