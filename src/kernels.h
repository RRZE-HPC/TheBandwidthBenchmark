...
extern double striad(double *a, const double *b, const double *c, const double *d, size_t N);
...
extern double update_seq(
    double *a, double scalar, size_t N, size_t iter);
...
extern double daxpy_seq(
    double *a, const double *b, double scalar, size_t N, size_t iter);
...
extern double update_tp(
    const double *a, double scalar, size_t N, size_t iter);
