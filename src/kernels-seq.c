...
double triad_seq(double *restrict a, double *restrict b, double *restrict c,
...
double daxpy_seq(double *restrict a, double *restrict b, double scalar, int N,
                 int iter) {
  HARNESS(a[i] = a[i] + scalar * b[i])
}

double sdaxpy_seq(double *restrict a, double *restrict b, double *restrict c,
                  int N, int iter) {
